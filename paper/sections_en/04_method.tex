...
\input{figures/hypergraph_schema_en}
...
\begin{enumerate}
  ...
  \item \textbf{Passage feature extraction.} For each passage, concatenate retrieval scores and ranks, biomedical semantic scores, entity overlap, MeSH exact and hierarchy features, auxiliary relation features, diffusion scores, centrality, and local graph-count features.
