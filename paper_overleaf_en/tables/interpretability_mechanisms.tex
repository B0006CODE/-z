...
\centering
\small
\caption{Quantitative interpretability: three-mechanism classification of 648 rescued gold passages (out of 661 total rescued; 13 did not clearly map to a single dominant mechanism). Each case is assigned to the dominant hypergraph mechanism based on activated feature scores.}
