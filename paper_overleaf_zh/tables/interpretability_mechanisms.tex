...
\centering
\small
\caption{Quantitative interpretability: three-mechanism classification of 648 rescued gold passages (moved from outside top-10 by Hybrid RRF to inside top-10 by KCH-MedRank). Each case is assigned to the dominant hypergraph mechanism based on activated feature scores.}
