...
| Knowledge hypergraph + MeSH + PrimeKG | test | 0.3866 | 0.4832 | 0.5564 | 0.7565 | 0.5957 | hg=0.02, entity=0.02, mesh=0.02, relation=0.00 |
...
| Remove PrimeKG relation expansion | test | 0.3866 | 0.4832 | 0.5564 | 0.7565 | 0.5957 | relation=0.00 selected |

Interpretation: current dictionary-only entity features, lexical MeSH matching, and exact-name PrimeKG mapping are weak. Adding MeSH or PrimeKG relation hyperedges changes held-out metrics only marginally and does not beat Hybrid RRF on MRR@10 or nDCG@10. The evidence supports improving concept normalization before making stronger claims about hypergraph reranking.
