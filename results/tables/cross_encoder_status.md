...
| PubMedQA pqa_labeled | Hybrid sample2 top5 -> MedCPT cross-encoder | timed out on CPU | `ncbi/MedCPT-Cross-Encoder` transformers backend added, but 300s CPU smoke test did not write metrics |
