...
Accessed date for all links: 2026-05-25.

| Citation key | Verified source | Notes |
| --- | --- | --- |
...
| `lewis2020rag` | https://arxiv.org/abs/2005.11401 | Official arXiv metadata for foundational RAG paper. |
| `edge2024graphrag` | https://arxiv.org/abs/2404.16130 | Official arXiv metadata for GraphRAG local-to-global search; current arXiv version lists ten authors. |
...
| `wang2026hgrag` | https://ojs.aaai.org/index.php/AAAI/article/view/40623 | Official AAAI proceedings metadata for cross-granularity HGRAG; DOI 10.1609/aaai.v40i39.40623. |
...
| `thakur2021beir` | https://datasets-benchmarks-proceedings.neurips.cc/paper/2021/hash/65b9eea6e1cc6bb9f0cd2a47751a186f-Abstract-round2.html | Official NeurIPS Datasets and Benchmarks metadata for BEIR; used for the external NFCorpus retrieval diagnostic. |
| `bodenreider2004umls` | https://pubmed.ncbi.nlm.nih.gov/14681409/ | PubMed metadata for the UMLS overview article. |
| `leaman2013dnorm` | https://academic.oup.com/bioinformatics/article/29/22/2909/312804 | Official Bioinformatics metadata for DNorm. |
